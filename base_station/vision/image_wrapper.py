...
class ImageWrapper:
    ...
    def find_contours(self):
        img, contours, hierarchy = self.__open_cv.findContours(self.__image, self.__open_cv.RETR_LIST,
                                                               self.__open_cv.CHAIN_APPROX_SIMPLE)
        return contours

    def find_hough_circles(self, min_distance, param1, param2, min_radius, max_radius):
        return self.__open_cv.HoughCircles(self.__image, self.__open_cv.HOUGH_GRADIENT, 1, min_distance, param1=param1,
