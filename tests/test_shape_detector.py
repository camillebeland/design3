...
class ImageMockCirclesNotFound:
    def filter_median_blur(self, kernel_size=5):
        return ImageMockCirclesNotFound()
...
class TestShapeDetector:
    def setup(self):
        ...
        self.image_mock_circle_not_found = ImageMockCirclesNotFound()
        self.shape_detector = ShapeDetector()

    def test_find_circle_color_with_circles_should_return_circles(self):
    ...
    def test_find_circle_color_withoud_circles_should_return_no_circles(self):
        circles = self.shape_detector.find_circle_color(self.image_mock_circle_not_found, 'blue', test_polygon_params)
        PARSED_FOUND_CIRCLES = []
        assert_equal(PARSED_FOUND_CIRCLES, circles)
