...
La Description des propriétés fonctionnelles (DPF), représenté par la figure \ref{fig:dpf}, permet de visualiser les exigences du client ainsi que de les associer aux fonctionnalités du produit. Les relations entre les exigences et les fonctionnalités sont représentées par des chiffres de 1 (faible) à 5 (élevé).
