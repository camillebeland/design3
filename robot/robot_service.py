...
class RobotService:
    ...
    def __init__(self, base_station_address, island_server_3109_address):
        self.base_station_address = base_station_address
        self.island_server_3109_address = island_server_3109_address
    ...
    def ask_target_island(self, manchester_letter):
        ...
        response = requests.get(str(self.island_server_3109_address), params=payload)
